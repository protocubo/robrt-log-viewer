// Generated by Haxe 3.3.0 (git build development @ 6572d5d)
...
tink_template__$Html_Html_$Impl_$.escape = function(s) {
	...
	case "\"":
		var tmp = start;
		start = pos;
		ret += s.substring(tmp,start - 1) + "&quot;";
		break;
	case "&":
		var tmp1 = start;
		start = pos;
		ret += s.substring(tmp1,start - 1) + "&amp;";
		break;
	case "<":
		var tmp2 = start;
		start = pos;
		ret += s.substring(tmp2,start - 1) + "&lt;";
		break;
	case ">":
		var tmp3 = start;
		start = pos;
		ret += s.substring(tmp3,start - 1) + "&gt;";
		break;
	}
